...
const Color kSplash = Color.fromARGB(244, 7, 16, 144);
...
final kEncodeSnasbold = GoogleFonts.encodeSans(
  fontWeight: FontWeight.w700,

);

final kEncodeSnasSemibold = GoogleFonts.encodeSans(
  fontWeight: FontWeight.w600,

);

final kEncodeSnasMedium= GoogleFonts.encodeSans(
  fontWeight: FontWeight.w500,

);

final kEncodeSnasRegular = GoogleFonts.encodeSans(
